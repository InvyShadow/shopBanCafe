...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('/public/frontend/images/favicon.jpg')}}">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/trang-chu')}}"><img src="{{(asset('public/frontend/images/logo2.png'))}}"
                                    alt="" /></a>
                        </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('public/frontend/images/cafe_3.jpg')}}" class="girl img-responsive"
                                        alt="" />
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('public/frontend/images/cafe_2.jpg')}}" class="girl img-responsive"
                                        alt="" />
                            ...
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>Quả mọng</span>-Anh đào</h1>
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('public/frontend/images/cafe_1.jpg')}}" class="girl img-responsive"
                                        alt="" />
                                    <!-- <img src="{{asset('public/frontend/images/girl3.jpg')}}" class="girl img-responsive"
                                        alt="" /> -->
                                    <!-- <img src="{{asset('asset()/frontend/images/pricing.png')}}" class="pricing" alt="" /> -->
                                </div>
                            </div>
                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{asset('public/frontend/images/char_1.png')}}" alt="" />
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{asset('public/frontend/images/char_2.png')}}" alt="" />
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="single-widget">
                            <h2>Về chúng tôi</h2>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="https://www.facebook.com/nhatquang.idol19">Nhật Quang</a></li>
                                <li><a href="https://www.facebook.com/mainem.0605/">Phương Nam</a></li>
                                <li><a href="https://bom.so/ytuongdoancoffee">Ý tưởng đồ án</a></li>
